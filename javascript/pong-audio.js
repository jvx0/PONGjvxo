...
export var wallSound = new soundFile("wall.sound.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("door.knock.right.mp3");
soundArray.push(paddleSound);

export var scoreSound = new soundFile("door.knock.left.mp3");
...
export var adventureMusic = new soundFile("background_soundmp3.mp3");
